...
export const HiveIcon = ({ size }: IconProps) => {
  const paths = (
    <>
      <g>
      ...
      <g>
        <path
          fill="#f7da21"
          d="m13.2 8 2-3-1.8-3h-3.58l-1.8 3 1.8 3zm-3.68 1-1.8 3 1.8 3h3.58l1.8-3-1.8-3zm6.24 2.51h3.59l1.79-3-1.79-3h-3.59l-1.8 3zm3.59 1h-3.59l-1.8 3 1.8 3h3.59l1.79-3zm-11.6-1 1.8-2.2-1.8-3H3.96l-1.3 3 1.79 3zm0 1H3.96l-1.2 3 1.79 3h3.59l1.8-3zM10.21 16l-1.8 3 1.8 3h3.58l1.8-3-1.8-3z"
        />
      </g>
      <g>
        <path
